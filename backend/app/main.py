...
from app.rag.indexing import create_collection_if_missing
...
async def lifespan(app: FastAPI):
    ...
    try:
        await asyncio.to_thread(create_collection_if_missing)
    except Exception:
        # Don't block startup: Qdrant may simply not be running yet.
